/* checksum : 35ccc75cf40ddd9fbd6b24f2e8ed3949 */
@cds.external : true
...
entity API_BUSINESS_PARTNER.A_BPAddressIndependentEmail {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity API_BUSINESS_PARTNER.A_BPAddressIndependentFax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity API_BUSINESS_PARTNER.A_BPAddressIndependentMobile {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity API_BUSINESS_PARTNER.A_BPAddressIndependentPhone {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity API_BUSINESS_PARTNER.A_BPAddressIndependentWebsite {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity API_BUSINESS_PARTNER.A_BusinessPartner {
  ...
  @sap.quickinfo : 'Company ID of Trading Partner'
  TradingPartner : String(6);
  to_AddressIndependentEmail : Association to many API_BUSINESS_PARTNER.A_BPAddressIndependentEmail {  };
  to_AddressIndependentFax : Association to many API_BUSINESS_PARTNER.A_BPAddressIndependentFax {  };
  to_AddressIndependentMobile : Association to many API_BUSINESS_PARTNER.A_BPAddressIndependentMobile {  };
  to_AddressIndependentPhone : Association to many API_BUSINESS_PARTNER.A_BPAddressIndependentPhone {  };
  to_AddressIndependentWebsite : Association to many API_BUSINESS_PARTNER.A_BPAddressIndependentWebsite {  };
